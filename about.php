...
<div class="container"><font face="proxima nova soft">
	...
	<div><font face="proxima nova soft">
		...
		<font align = "center">
		<img src="images/closet.jpg" align="middle">
		</font>
		...
		<font align = "center">
		<img src="images/colors.jpg" align="middle">
		</font>
		...
		<p>On her <a href="http://own-it.us" target="blank">own-it.us</a> project, artist Mary Mattingly wrote: &quot;From the over-extraction of the earth, to the working conditions of the makers and distributors, to the chemicals that enter the air and water affecting everyone, each object is embedded with trauma.&quot;</p>

		<p>If manufacturers were required to detail how clothing items were made, the working conditions they were made under, the materials used, where these materials were extracted from and at what cost, the method of production, and the effects of all of these things on laborers and the natural world, people could fully understand the history of their items (even those bought second hand). This could motivate users to make more ethical decisions by bringing greater attention to the issues surrounding and resulting from clothing manufacturing (e.g. human rights issues, environmental issues, etc). It could also allow users to ask themselves: Does my use of this item truly outweigh the price and effects of its production?</p>

		<p>Similar projects and inspirations for Minimize include:</p>
		<ul>
			...
			<li><a href="http://chrisspeed.net/?page_id=351#">RememberMe</a></li>
